      ...
      <Card className='mt-4 border-dashed shadow-none'>
        ...
        <CardContent className='text-center'>
          ...
          <p className='text-muted-foreground text-sm'>
            (Add habit button/link coming soon)
          </p>
        </CardContent>
      </Card>
    )
  ...
  return (
    ...
    <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
      {habits.map((habit: Habit) => (
        ...
        <Card
          key={habit.id}
          className='bg-card hover:border-primary/30 flex flex-col overflow-hidden transition-all duration-150 ease-in-out hover:shadow-md'
        >
          ...
          <CardContent className='flex flex-grow flex-col justify-between'>
            ...
            <div className='mt-auto pt-4'>
              ...
              <div className='text-muted-foreground bg-muted/30 flex h-10 items-center justify-center rounded border text-xs'>
          ...
          <CardFooter className='text-muted-foreground flex items-center justify-between pt-4 text-xs'>
